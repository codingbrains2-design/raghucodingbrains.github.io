...
<header id="topnav">
    <div class="topbar-main">
        <div class="container">
            ...
            <!-- Logo container-->
            <div class="logo">
                <a href="http://coderthemes.com/ubold_2.1/menu_2/index.html" class="logo"><span>HRM</span></a>
            </div>
            <!-- End Logo container-->
            ...
            <div class="menu-extras">
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    ...
                    <li class="dropdown navbar-c-items">
                        <a href="http://coderthemes.com/ubold_2.1/menu_2/index.html" class="dropdown-toggle waves-effect waves-light profile" data-toggle="dropdown" aria-expanded="true">
                            {{ Html::image('images/me.jpg','',array("class"=>"img-circle"))}}
                        </a>
